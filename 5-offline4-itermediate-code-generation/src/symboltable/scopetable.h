...
class ScopeTable
{
    ...
    int varCnt; // local variable counter
...
public: // public constructor & funtions ===============================
    ...
    ScopeTable(int n, ScopeTable *parentScopeTable)
    {
        ...
        //cout << "ScopeTable:: New ScopeTable with id " << id << " created" << endl<< endl;
    }
    ...
    int getVarCnt()
    {
        int parentVarCnt = parentScopeTable!=nullptr ? parentScopeTable->getVarCnt(): 0;
        return varCnt + parentVarCnt;   
    }
